...
The supported events and its use in the library is a functionality that is still being worked on
...
![Javascript](https://img.shields.io/badge/-JavaScript-EC4A3F?logo=javascript&logoColor=white&style=for-the-badge)
![Vue.js](https://img.shields.io/badge/-Vue.js-6E9F18?logo=vuedotjs&logoColor=white&style=for-the-badge)
