...
The **SPACE Vue SDK** provides fully-typed Vue/TypeScript **components, hooks, and utilities** to seamlessly integrate your web apps with SPACE.  

With this SDK you can:

- ⚡ **Connect** a Vue application to a **SPACE** instance (HTTP + WebSocket).
...
# or
yarn add space-vue-client
# or
pnpm add space-vue-client
```
...
import { SpaceProvider } from 'space-Vue-client';
import App from './App';
...
import { useSpaceClient } from 'space-Vue-client';
...
```tsx
import { Feature, On, Default, Loading, ErrorFallback } from 'space-Vue-client';
...
```tsx
import { useEffect } from 'Vue';
import { usePricingToken } from 'space-Vue-client';
