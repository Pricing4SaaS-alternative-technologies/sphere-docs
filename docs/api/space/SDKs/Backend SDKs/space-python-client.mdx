...
# SPACE Client SDK for Python.js

[![npm version](https://img.shields.io/npm/v/space-python-client.svg)](https://www.npmjs.com/package/space-python-client)

A fully-typed **TypeScript/Python.js SDK** for interacting with [SPACE](../../introduction.mdx).  
...
```bash
npm install space-python-client
# or
yarn add space-python-client
# or
pnpm add space-python-client
```
...
```typescript
import { connect, SpaceClient } from 'space-python-client';
...
You can attach listeners using the **Python client**:
...
This project is licensed under the MIT License. See [LICENSE](https://github.com/Alex-GF/space-python-client/blob/main/LICENSE) for details.
